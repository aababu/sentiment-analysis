...
public class PCA {
	...
	double[][] indat = new double[10000][6];
	static Matrix rowproj;

	public void inputdata(double parameter[][], int n, int m) {
		for (int i = 0; i < n; i++) {
			for (int j = 0; j < m; j++) {
				indat[i][j] = parameter[i][j];
			}
		}
		...
		//System.out.println();
		// System.out.println(" Transformed in new principal component space:");
		rowproj = X.times(Evecs);
		// rowproj.print(10,4);
	...
	public static double[][] gettransformeddata() {
